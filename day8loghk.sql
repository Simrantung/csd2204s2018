...
MariaDB [csd2204s18]> SELECT first_name, last_name, salary FROM employees WHERE salary> (SELECT salary FROM employee WHERE last_name LIKE 'Bull');
...
MariaDB [csd2204s18]> SELECT department_id, dapartment_name FROM departments WHERE department_name LIKE 'IT%';
...
Empty set, 54 warnings (0.02 sec)
...
MariaDB [csd2204s18]> SELECT first_name, last_name, salary, job_id FROM employees WHERE salary= (SELECT MIN_SALARY FROM jobs WHERE employee.job_id= jobs.job_id);
ERROR 1054 (42S22): Unknown column 'employee.job_id' in 'where clause'
...
MariaDB [csd2204s18]> SELECT first_name, last_name, salary, departmemt_id FROM employees WHERE salary>(SELECT avg(salary) FROM employees) AND department_id IN (SELECT department_id FROM departments WHERE department_name LIKE 'IT%');
ERROR 1054 (42S22): Unknown column 'departmemt_id' in 'field list'
